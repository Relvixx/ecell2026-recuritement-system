...
import { clearAdminSession, adminFetch, adminFetchBlob, AdminAuthError, getAdminUser } from './adminApi';
...
export default function AdminDashboard() {
  ...
  function logout() { clearAdminSession(); router.replace('/admin'); }
  function openCandidate(id) { const query = new URLSearchParams(params.toString()); query.set('candidate', id); query.set('view', 'candidates'); router.push(`/admin/dashboard?${query.toString()}`); }
  function closeCandidate() { const query = new URLSearchParams(params.toString()); query.delete('candidate'); router.push(`/admin/dashboard?${query.toString()}`); }

export const TEAM_ACCENT_TOKENS = {
  technical: {
    key: 'powder-blue',
    label: 'Powder Blue',
    surface: 'var(--color-powder-blue)',
    ink: 'var(--color-ink)'
  },
  design: {
    key: 'lavender',
    label: 'Lavender',
    surface: 'var(--color-lavender)',
    ink: 'var(--color-ink)'
  },
  documentation: {
    key: 'peach',
    label: 'Peach / Warm Cream',
    surface: 'var(--color-peach)',
    ink: 'var(--color-ink)'
  },
  social_media: {
    key: 'blush',
    label: 'Blush',
    surface: 'var(--color-blush)',
    ink: 'var(--color-ink)'
  },
  pr: {
    key: 'coral',
    label: 'Soft Coral / Peach',
    surface: 'var(--color-coral)',
    ink: 'var(--color-ink)'
  },
  event: {
    key: 'butter',
